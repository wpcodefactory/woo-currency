<?php
class userWcu extends moduleWcu {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameWcu::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameWcu::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbWcu::get('SELECT * FROM #__users
