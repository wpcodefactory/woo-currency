...
<div class="wcuWidgetRow">
	<?php echo htmlWcu::checkbox($this->widget->get_field_name('show_flag_currency_list'), array(
		'attrs' => "style='float:left; margin-top:0px; margin-right:5px;' id='" . $this->widget->get_field_id('show_flag_currency_list') . "' ".$proFlagsDisabled." ",
		'value' => ($showFlags && isset($this->data['show_flag_currency_list'])) ?  '1'  : '0',
		'checked' => ($showFlags && isset($this->data['show_flag_currency_list'])) ? 'checked' : '',
	));?>
	<label for="<?php echo $this->widget->get_field_id('show_flag_currency_list'); ?>"><?php _e('show flags in currency list', WCU_LANG_CODE) ?> <?php echo $proFlagsSup ?></label>
</div>
